...
abstract class AppLocalizations {
  ...
  /// No description provided for @auth_noEmailError.
  ///
  /// In en, this message translates to:
  ...
  String get auth_invalidEmailError;

  /// No description provided for @auth_noPasswordError.
  ///
  /// In en, this message translates to:
  /// **'Please enter your password'**
  String get auth_noPasswordError;

  /// No description provided for @auth_shortPasswordError.
  ///
  /// In en, this message translates to:
